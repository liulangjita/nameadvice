$('.form_datetime').datetimepicker({
    ...
    function query(){
        ...
        $.post("/analyse_bazi",
		{
			...
			$.post("/query",
			{
						'tonglei':tonglei,'rigan_wx':rigan_wx,'is_weak':is_weak,'minTong':minTong,'minYi':minYi,'wuxingscore':wuxingscore.join(),'xing':xing,'sex':sex,'doublename':doublename,'firstname':firstname,'secname':secname},
				function(data,status){
